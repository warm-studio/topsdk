...
class TaobaoItemUpdateRequest {
    ...
    public function getEmptyFields() : string{
        return $this->emptyFields;
    }

    public function setEmptyFields(string $emptyFields){
    ...
    public function toMap() : array{
        ...
        if (!TopUtil::checkEmpty($this->emptyFields)) {
            $requestParam["empty_fields"] = TopUtil::convertBasic($this->emptyFields);
        }
