...
class AlibabaWdkMarketingItempoolActivityCreateOpenPromotionRuleStair {
    ...
    public function getCapCountDiscountRule() : AlibabaWdkMarketingItempoolActivityCreateCapCountDiscountRule{
        return $this->cap_count_discount_rule;
    }

    public function setCapCountDiscountRule(AlibabaWdkMarketingItempoolActivityCreateCapCountDiscountRule $capCountDiscountRule){
    ...
    public function getCountAtDiscountRule() : AlibabaWdkMarketingItempoolActivityCreateCountAtDiscountRule{
        return $this->count_at_discount_rule;
    }

    public function setCountAtDiscountRule(AlibabaWdkMarketingItempoolActivityCreateCountAtDiscountRule $countAtDiscountRule){
    ...
    public function getSeparatePricingDiscountRule() : AlibabaWdkMarketingItempoolActivityCreateSeparatePricingDiscountRule{
        return $this->separate_pricing_discount_rule;
    }

    public function setSeparatePricingDiscountRule(AlibabaWdkMarketingItempoolActivityCreateSeparatePricingDiscountRule $separatePricingDiscountRule){
