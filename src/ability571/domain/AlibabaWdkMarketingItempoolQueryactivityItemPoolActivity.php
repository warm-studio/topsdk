...
class AlibabaWdkMarketingItempoolQueryactivityItemPoolActivity {
    ...
    public function getLimitInfo() : AlibabaWdkMarketingItempoolQueryactivityLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaWdkMarketingItempoolQueryactivityLimitInfo $limitInfo){
