...
class AlibabaWdkCouponSkuAddCouponTemplateItemRequest {
    ...
    public function getUserInfo() : AlibabaWdkCouponSkuAddUserInfo{
        return $this->user_info;
    }

    public function setUserInfo(AlibabaWdkCouponSkuAddUserInfo $userInfo){
