...
class AlibabaHmMarketingDiscountItemAddAsyncItemDiscountSku {
    ...
    public function getLimitInfo() : AlibabaHmMarketingDiscountItemAddAsyncLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingDiscountItemAddAsyncLimitInfo $limitInfo){
