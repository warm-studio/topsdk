...
class AlibabaWdkMarketingFullrangeQueryitemActivitySkuQuery {
    ...
    public function getPage() : AlibabaWdkMarketingFullrangeQueryitemBasePageQuery{
        return $this->page;
    }

    public function setPage(AlibabaWdkMarketingFullrangeQueryitemBasePageQuery $page){
        $this->page = $page;
    }
