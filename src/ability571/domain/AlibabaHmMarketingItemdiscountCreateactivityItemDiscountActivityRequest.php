...
class AlibabaHmMarketingItemdiscountCreateactivityItemDiscountActivityRequest {
    ...
    public function getPeriodConfig() : AlibabaHmMarketingItemdiscountCreateactivityPeriodConfig{
        return $this->period_config;
    }

    public function setPeriodConfig(AlibabaHmMarketingItemdiscountCreateactivityPeriodConfig $periodConfig){
