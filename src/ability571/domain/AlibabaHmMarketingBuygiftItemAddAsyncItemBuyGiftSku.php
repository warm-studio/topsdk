...
class AlibabaHmMarketingBuygiftItemAddAsyncItemBuyGiftSku {
    ...
    public function getLimitInfo() : AlibabaHmMarketingBuygiftItemAddAsyncLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingBuygiftItemAddAsyncLimitInfo $limitInfo){
