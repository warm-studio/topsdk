...
class AlibabaHmMarketingCouponQueryitemsActivitySkuQuery {
    ...
    public function getPage() : AlibabaHmMarketingCouponQueryitemsBasePageQuery{
        return $this->page;
    }

    public function setPage(AlibabaHmMarketingCouponQueryitemsBasePageQuery $page){
        $this->page = $page;
    }
