...
class AlibabaHmMarketingItempoolActivityCreateItemPoolActivity {
    ...
    public function getLimitInfo() : AlibabaHmMarketingItempoolActivityCreateLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingItempoolActivityCreateLimitInfo $limitInfo){
    ...
    public function getActivityRule() : AlibabaHmMarketingItempoolActivityCreateActivityRule{
        return $this->activity_rule;
    }

    public function setActivityRule(AlibabaHmMarketingItempoolActivityCreateActivityRule $activityRule){
    ...
    public function getPeriodConfig() : AlibabaHmMarketingItempoolActivityCreatePeriodConfig{
        return $this->period_config;
    }

    public function setPeriodConfig(AlibabaHmMarketingItempoolActivityCreatePeriodConfig $periodConfig){
