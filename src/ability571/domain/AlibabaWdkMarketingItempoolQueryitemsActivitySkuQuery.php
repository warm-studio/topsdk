...
class AlibabaWdkMarketingItempoolQueryitemsActivitySkuQuery {
    ...
    public function getPage() : AlibabaWdkMarketingItempoolQueryitemsBasePageQuery{
        return $this->page;
    }

    public function setPage(AlibabaWdkMarketingItempoolQueryitemsBasePageQuery $page){
        $this->page = $page;
    }
