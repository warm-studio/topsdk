...
class AlibabaHmMarketingFullrangeCreateactivityFullRangeActivity {
    ...
    public function getLimitInfo() : AlibabaHmMarketingFullrangeCreateactivityLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingFullrangeCreateactivityLimitInfo $limitInfo){
