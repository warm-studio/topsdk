...
class AlibabaHmMarketingItemdiscountQueryitemsItemDiscountSku {
    ...
    public function getLimitInfo() : AlibabaHmMarketingItemdiscountQueryitemsLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingItemdiscountQueryitemsLimitInfo $limitInfo){
