...
use Topsdk\Topapi\Ability571\Domain\AlibabaWdkMarketingItempoolItemAddAsyncCommonActivityParam;
...
class AlibabaWdkMarketingItempoolItemAddAsyncRequest {
    ...
    public function getParam1() : AlibabaWdkMarketingItempoolItemAddAsyncCommonActivityParam{
        return $this->param1;
    }

    public function setParam1(AlibabaWdkMarketingItempoolItemAddAsyncCommonActivityParam $param1){
        $this->param1 = $param1;
    }
