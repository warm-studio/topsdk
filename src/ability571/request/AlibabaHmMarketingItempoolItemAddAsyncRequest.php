...
use Topsdk\Topapi\Ability571\Domain\AlibabaHmMarketingItempoolItemAddAsyncCommonActivityParam;

class AlibabaHmMarketingItempoolItemAddAsyncRequest {
    ...
    public function getParam1() : AlibabaHmMarketingItempoolItemAddAsyncCommonActivityParam{
        return $this->param1;
    }

    public function setParam1(AlibabaHmMarketingItempoolItemAddAsyncCommonActivityParam $param1){
        $this->param1 = $param1;
    }
