...
use Topsdk\Topapi\Ability571\Domain\AlibabaWdkMarketingBuygiftItemRemoveAsyncCommonActivityParam;
...
class AlibabaWdkMarketingBuygiftItemRemoveAsyncRequest {
    ...
    public function getParam1() : AlibabaWdkMarketingBuygiftItemRemoveAsyncCommonActivityParam{
        return $this->param1;
    }

    public function setParam1(AlibabaWdkMarketingBuygiftItemRemoveAsyncCommonActivityParam $param1){
        $this->param1 = $param1;
    }
