...
use Topsdk\Topapi\Ability571\Domain\AlibabaWdkMarketingDiscountItemRemoveAsyncCommonActivityParam;

class AlibabaWdkMarketingDiscountItemRemoveAsyncRequest {
    ...
    public function getParam1() : AlibabaWdkMarketingDiscountItemRemoveAsyncCommonActivityParam{
        return $this->param1;
    }

    public function setParam1(AlibabaWdkMarketingDiscountItemRemoveAsyncCommonActivityParam $param1){
        $this->param1 = $param1;
    }
