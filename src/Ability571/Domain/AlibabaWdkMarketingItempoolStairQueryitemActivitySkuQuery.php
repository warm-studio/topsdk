...
class AlibabaWdkMarketingItempoolStairQueryitemActivitySkuQuery {
    ...
    public function getPage() : AlibabaWdkMarketingItempoolStairQueryitemBasePageQuery{
        return $this->page;
    }

    public function setPage(AlibabaWdkMarketingItempoolStairQueryitemBasePageQuery $page){
        $this->page = $page;
    }
