...
class AlibabaHmMarketingItembuygiftQueryitemsActivitySkuQuery {
    ...
    public function getPage() : AlibabaHmMarketingItembuygiftQueryitemsBasePageQuery{
        return $this->page;
    }

    public function setPage(AlibabaHmMarketingItembuygiftQueryitemsBasePageQuery $page){
        $this->page = $page;
    }
