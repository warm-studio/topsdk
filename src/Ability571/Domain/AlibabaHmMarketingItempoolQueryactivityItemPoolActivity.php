...
class AlibabaHmMarketingItempoolQueryactivityItemPoolActivity {
    ...
    public function getLimitInfo() : AlibabaHmMarketingItempoolQueryactivityLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingItempoolQueryactivityLimitInfo $limitInfo){
