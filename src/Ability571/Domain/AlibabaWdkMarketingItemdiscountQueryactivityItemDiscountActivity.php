...
class AlibabaWdkMarketingItemdiscountQueryactivityItemDiscountActivity {
    ...
    public function getPeriodConfig() : AlibabaWdkMarketingItemdiscountQueryactivityPeriodConfig{
        return $this->period_config;
    }

    public function setPeriodConfig(AlibabaWdkMarketingItemdiscountQueryactivityPeriodConfig $periodConfig){
