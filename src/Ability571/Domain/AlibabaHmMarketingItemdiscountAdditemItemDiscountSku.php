...
class AlibabaHmMarketingItemdiscountAdditemItemDiscountSku {
    ...
    public function getLimitInfo() : AlibabaHmMarketingItemdiscountAdditemLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingItemdiscountAdditemLimitInfo $limitInfo){
