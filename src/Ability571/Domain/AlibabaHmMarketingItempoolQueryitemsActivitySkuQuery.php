...
class AlibabaHmMarketingItempoolQueryitemsActivitySkuQuery {
    ...
    public function getPage() : AlibabaHmMarketingItempoolQueryitemsBasePageQuery{
        return $this->page;
    }

    public function setPage(AlibabaHmMarketingItempoolQueryitemsBasePageQuery $page){
        $this->page = $page;
    }
