...
class AlibabaHmMarketingItempoolCreateactivityItemPoolActivity {
    ...
    public function getLimitInfo() : AlibabaHmMarketingItempoolCreateactivityLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingItempoolCreateactivityLimitInfo $limitInfo){
