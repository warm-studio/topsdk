...
class AlibabaHmMarketingItembuygiftQueryitemsData {
    ...
    public function getLimitInfo() : AlibabaHmMarketingItembuygiftQueryitemsLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingItembuygiftQueryitemsLimitInfo $limitInfo){
