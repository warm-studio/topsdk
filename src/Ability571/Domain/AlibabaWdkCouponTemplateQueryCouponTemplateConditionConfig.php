...
class AlibabaWdkCouponTemplateQueryCouponTemplateConditionConfig {
    ...
    public function getUserCrowdConfig() : AlibabaWdkCouponTemplateQueryCouponTemplateUserCrowdConfig{
        return $this->user_crowd_config;
    }

    public function setUserCrowdConfig(AlibabaWdkCouponTemplateQueryCouponTemplateUserCrowdConfig $userCrowdConfig){
