...
class AlibabaWdkMarketingFullrangeQueryactivityItemPoolActivity {
    ...
    public function getLimitInfo() : AlibabaWdkMarketingFullrangeQueryactivityLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaWdkMarketingFullrangeQueryactivityLimitInfo $limitInfo){
