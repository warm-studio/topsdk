...
class AlibabaHmMarketingCouponCreateactivityCouponActivity {
    ...
    public function getLimitInfo() : AlibabaHmMarketingCouponCreateactivityLimitInfo{
        return $this->limit_info;
    }

    public function setLimitInfo(AlibabaHmMarketingCouponCreateactivityLimitInfo $limitInfo){
