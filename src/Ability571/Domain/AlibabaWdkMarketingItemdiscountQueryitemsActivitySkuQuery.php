...
class AlibabaWdkMarketingItemdiscountQueryitemsActivitySkuQuery {
    ...
    public function getPage() : AlibabaWdkMarketingItemdiscountQueryitemsBasePageQuery{
        return $this->page;
    }

    public function setPage(AlibabaWdkMarketingItemdiscountQueryitemsBasePageQuery $page){
        $this->page = $page;
    }
