...
use Topsdk\Topapi\Ability571\Domain\AlibabaWdkMarketingDiscountItemAddAsyncCommonActivityParam;

class AlibabaWdkMarketingDiscountItemAddAsyncRequest {
    ...
    public function getParam1() : AlibabaWdkMarketingDiscountItemAddAsyncCommonActivityParam{
        return $this->param1;
    }

    public function setParam1(AlibabaWdkMarketingDiscountItemAddAsyncCommonActivityParam $param1){
        $this->param1 = $param1;
    }
