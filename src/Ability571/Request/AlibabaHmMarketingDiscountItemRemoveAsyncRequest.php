...
use Topsdk\Topapi\Ability571\Domain\AlibabaHmMarketingDiscountItemRemoveAsyncCommonActivityParam;

class AlibabaHmMarketingDiscountItemRemoveAsyncRequest {
    ...
    public function getParam1() : AlibabaHmMarketingDiscountItemRemoveAsyncCommonActivityParam{
        return $this->param1;
    }

    public function setParam1(AlibabaHmMarketingDiscountItemRemoveAsyncCommonActivityParam $param1){
        $this->param1 = $param1;
    }
