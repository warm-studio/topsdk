...
use Topsdk\Topapi\Ability571\Domain\AlibabaHmMarketingDiscountItemAddAsyncCommonActivityParam;

class AlibabaHmMarketingDiscountItemAddAsyncRequest {
    ...
    public function getParam1() : AlibabaHmMarketingDiscountItemAddAsyncCommonActivityParam{
        return $this->param1;
    }

    public function setParam1(AlibabaHmMarketingDiscountItemAddAsyncCommonActivityParam $param1){
        $this->param1 = $param1;
    }
