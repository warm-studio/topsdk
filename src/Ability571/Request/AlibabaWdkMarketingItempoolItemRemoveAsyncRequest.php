...
use Topsdk\Topapi\Ability571\Domain\AlibabaWdkMarketingItempoolItemRemoveAsyncCommonActivityParam;

class AlibabaWdkMarketingItempoolItemRemoveAsyncRequest {
    ...
    public function getParam1() : AlibabaWdkMarketingItempoolItemRemoveAsyncCommonActivityParam{
        return $this->param1;
    }

    public function setParam1(AlibabaWdkMarketingItempoolItemRemoveAsyncCommonActivityParam $param1){
        $this->param1 = $param1;
    }
