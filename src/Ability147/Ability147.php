...
use Topsdk\Topapi\Ability147\Request\TmallItemAddSimpleschemaGetRequest;
...
class Ability147 {
    ...
    **/
    ...
    /**
        天猫发布商品规则获取
    **/
    public function tmallItemAddSimpleschemaGet(TmallItemAddSimpleschemaGetRequest $request,string $session) {
        return $this->client->executeWithSession("tmall.item.add.simpleschema.get", $request->toMap(), $request->toFileParamMap(), $session);
    }
    /**
        产品更新规则获取接口
    **/
